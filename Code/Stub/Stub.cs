...
namespace Stub
{
    public class Stub : IPersistanceManager
    {
        ...
        public (IEnumerable<Personnage> personnages, IEnumerable<Arc> arcs, IEnumerable<Haki> hakis) ChargeDonnees()
        {
            ...
            ListeArc.Add(Arc2);
            Arc Arc3 = new Arc("Capitaine Kuro", "hgquf", new ClassLibrary1.Image("ImageArc/kuro.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc3);     
            Arc Arc4 = new Arc("Baratie", "hgquf", new ClassLibrary1.Image("ImageArc/baratie.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc4);
            Arc Arc5 = new Arc("Arlong", "hgquf", new ClassLibrary1.Image("ImageArc/arlong.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc5);
            Arc Arc6 = new Arc("LogueTown", "hgquf", new ClassLibrary1.Image("ImageArc/loguetown.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc6);
            Arc Arc7 = new Arc("Laboon", "hgquf", new ClassLibrary1.Image("ImageArc/laboon.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc7);
            Arc Arc8 = new Arc("Whiskey Peak", "hgquf", new ClassLibrary1.Image("ImageArc/whiskey.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc8);
            Arc Arc9 = new Arc("Little Garden", "hgquf", new ClassLibrary1.Image("ImageArc/garden.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc9);
            Arc Arc10 = new Arc("Royaume de Drum", "hgquf", new ClassLibrary1.Image("ImageArc/drum.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc10);
            Arc Arc11 = new Arc("Alabasta", "hgquf", new ClassLibrary1.Image("ImageArc/alabasta.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc11);
            Arc Arc12 = new Arc("Jaya", "hgquf", new ClassLibrary1.Image("ImageArc/jaya.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc12);
            Arc Arc13 = new Arc("Skypiea", "hgquf", new ClassLibrary1.Image("ImageArc/skypiea.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc13);
            Arc Arc14 = new Arc("Davy Back Fight", "hgquf", new ClassLibrary1.Image("ImageArc/davy.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc14);
            Arc Arc15 = new Arc("Water Seven", "hgquf", new ClassLibrary1.Image("ImageArc/water.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc15);
            Arc Arc16 = new Arc("Enies Lobby", "hgquf", new ClassLibrary1.Image("ImageArc/enies.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc16);
            Arc Arc17 = new Arc("Post Enies Lobby", "hgquf", new ClassLibrary1.Image("ImageArc/post_enies.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc17);
            Arc Arc18 = new Arc("Thriller Bark", "hgquf", new ClassLibrary1.Image("ImageArc/thriller.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc18);
            Arc Arc19 = new Arc("Archipel Sabaody", "hgquf", new ClassLibrary1.Image("ImageArc/sabaody.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc19);
            Arc Arc20 = new Arc("Amazon Lily", "hgquf", new ClassLibrary1.Image("ImageArc/amazon.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc20);
            Arc Arc21 = new Arc("Impel Down", "hgquf", new ClassLibrary1.Image("ImageArc/impel.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc21);
            Arc Arc22 = new Arc("Marineford", "hgquf", new ClassLibrary1.Image("ImageArc/marineford.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc22);
            Arc Arc23 = new Arc("Post Marineford", "hgquf", new ClassLibrary1.Image("ImageArc/post_marineford.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc23);
            Arc Arc24 = new Arc("Retour a Sabaody", "hgquf", new ClassLibrary1.Image("ImageArc/retour.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc24);
            Arc Arc25 = new Arc("Hommes Poissons", "hgquf", new ClassLibrary1.Image("ImageArc/hommes.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc25);
            Arc Arc26 = new Arc("Punk Hazard", "hgquf", new ClassLibrary1.Image("ImageArc/punk.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc26);
            Arc Arc27 = new Arc("Dressrosa", "hgquf", new ClassLibrary1.Image("ImageArc/dressrosa.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc27);
            Arc Arc28 = new Arc("Mine Argentée", "hgquf", new ClassLibrary1.Image("ImageArc/mine.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc28);
            Arc Arc29 = new Arc("Zou", "hgquf", new ClassLibrary1.Image("ImageArc/zou.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc29);
            Arc Arc30 = new Arc("Whole Cake", "hgquf", new ClassLibrary1.Image("ImageArc/whole.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc30);
            Arc Arc31 = new Arc("Reverie", "hgquf", new ClassLibrary1.Image("ImageArc/reverie.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc31);
            Arc Arc32 = new Arc("Wano Kuni", "hgquf", new ClassLibrary1.Image("ImageArc/wano.png", "Luffy au début"), new List<Personnage> { Luffy });
            ListeArc.Add(Arc32);
