...
namespace Stub
{
    public class Stub : IPersistanceManager
    {
        ...
        public (IEnumerable<Personnage> personnages, IEnumerable<Arc> arcs, IEnumerable<Haki> hakis) ChargeDonnees()
        {
            ...
            ListeArc.Add(Arc4);
            Arc Arc5 = new Arc("Arlong", "Cinquième arc de One Piece", new ClassLibrary1.Image("ImageArc/arlong.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc5);
            Arc Arc6 = new Arc("LogueTown", "Sixième arc de One Piece", new ClassLibrary1.Image("ImageArc/loguetown.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc6);
            Arc Arc7 = new Arc("Laboon", "Septième arc de One Piece", new ClassLibrary1.Image("ImageArc/laboon.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc7);
            Arc Arc8 = new Arc("Whiskey Peak", "Huitième arc de One Piece", new ClassLibrary1.Image("ImageArc/whiskey.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc8);
            Arc Arc9 = new Arc("Little Garden", "Neuvième arc de One Piece", new ClassLibrary1.Image("ImageArc/garden.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc9);
            Arc Arc10 = new Arc("Royaume de Drum", "Dixième arc de One Piece", new ClassLibrary1.Image("ImageArc/drum.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc10);
            Arc Arc11 = new Arc("Alabasta", "Onzième arc de One Piece", new ClassLibrary1.Image("ImageArc/alabasta.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc11);
            Arc Arc12 = new Arc("Jaya", "Douzième arc de One Piece", new ClassLibrary1.Image("ImageArc/jaya.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji, Doflamingo });
            ListeArc.Add(Arc12);
            Arc Arc13 = new Arc("Skypiea", "Treizième arc de One Piece", new ClassLibrary1.Image("ImageArc/skypiea.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc13);
            Arc Arc14 = new Arc("Davy Back Fight", "Quatorzième arc de One Piece", new ClassLibrary1.Image("ImageArc/davy.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc14);
            Arc Arc15 = new Arc("Water Seven", "Quinzième arc de One Piece", new ClassLibrary1.Image("ImageArc/water.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc15);
            Arc Arc16 = new Arc("Enies Lobby", "Seizième arc de One Piece", new ClassLibrary1.Image("ImageArc/enies.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc16);
            Arc Arc17 = new Arc("Post Enies Lobby", "Dix Septième arc de One Piece", new ClassLibrary1.Image("ImageArc/post_enies.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc17);
            Arc Arc18 = new Arc("Thriller Bark", "Dix Huitième arc de One Piece", new ClassLibrary1.Image("ImageArc/thriller.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc18);
            Arc Arc19 = new Arc("Archipel Sabaody", "Dix Neuvième arc de One Piece", new ClassLibrary1.Image("ImageArc/sabaody.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc19);
            Arc Arc20 = new Arc("Amazon Lily", "Vingtième arc de One Piece", new ClassLibrary1.Image("ImageArc/amazon.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc20);
            Arc Arc21 = new Arc("Impel Down", "Vingt et unième arc de One Piece", new ClassLibrary1.Image("ImageArc/impel.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji, Doflamingo });
            ListeArc.Add(Arc21);
            Arc Arc22 = new Arc("Marineford", "Vingt Deuxième arc de One Piece", new ClassLibrary1.Image("ImageArc/marineford.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji, Doflamingo });
            ListeArc.Add(Arc22);
            Arc Arc23 = new Arc("Post Marineford", "Vingt Troisième arc de One Piece", new ClassLibrary1.Image("ImageArc/post_marineford.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc23);
            Arc Arc24 = new Arc("Retour a Sabaody", "Vingt Quatrième arc de One Piece", new ClassLibrary1.Image("ImageArc/retour.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc24);
            Arc Arc25 = new Arc("Hommes Poissons", "Vingt Cinquième arc de One Piece", new ClassLibrary1.Image("ImageArc/hommes.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc25);
            Arc Arc26 = new Arc("Punk Hazard", "Vingt Sizième arc de One Piece", new ClassLibrary1.Image("ImageArc/punk.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji, Doflamingo });
            ListeArc.Add(Arc26);
            Arc Arc27 = new Arc("Dressrosa", "Vingt Septième arc de One Piece", new ClassLibrary1.Image("ImageArc/dressrosa.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji, Doflamingo });
            ListeArc.Add(Arc27);
            Arc Arc28 = new Arc("Mine Argentée", "Vingt Huitième arc de One Piece", new ClassLibrary1.Image("ImageArc/mine.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc28);
            Arc Arc29 = new Arc("Zou", "Vingt Neuvième arc de One Piece", new ClassLibrary1.Image("ImageArc/zou.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc29);
            Arc Arc30 = new Arc("Whole Cake", "Trentième arc de One Piece", new ClassLibrary1.Image("ImageArc/whole.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc30);
            Arc Arc31 = new Arc("Reverie", "Trente et unième arc de One Piece", new ClassLibrary1.Image("ImageArc/reverie.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji, Doflamingo });
            ListeArc.Add(Arc31);
            Arc Arc32 = new Arc("Wano Kuni", "Trente Deuxième arc de One Piece", new ClassLibrary1.Image("ImageArc/wano.png", "Luffy au début"), new List<Personnage> { Luffy, Zoro, Sanji });
            ListeArc.Add(Arc32);
